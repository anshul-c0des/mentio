...
const FEATURES: Feature[] = [
  {
    ...
    description:
      "Instantly grasp the public mood with AI-powered sentiment analysis and concise summaries of all mentions.",
  },
  {
    icon: Search,
    title: "Multi-Platform Tracking",
    description:
      "Track your brand mentions across the most relevant channels: Reddit, YouTube, and key News sources.",
  },
  {
    icon: Zap,
    title: "Spike Alerts",
    description:
      "Get notified immediately when mention volume spikes, letting you address PR issues or capitalize on momentum.",
  },
  {
    icon: BarChart,
    title: "Deep Analytics",
    description:
      "Access comprehensive data and charts to understand mention frequency, source distribution, and historical trends.",
  },
];
...
export default function Home() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await axios.post(`${process.env.NEXT_PUBLIC_BACKEND_URL}/api/queries`, {
        name: brand.trim(),
      });
      ...
      <main className="w-full max-w-7xl z-10 px-4 md:px-6">
        <section className="py-16 md:py-36 lg:py-48 text-center relative">
          ...
          <p className="text-lg md:text-xl mb-10 max-w-3xl mx-auto font-light text-gray-800 dark:text-gray-300">
            ...
            your presence across social media and news.
          </p>
          ...
          <Card className="max-w-md mx-auto p-4 md:p-6 shadow-2xl dark:border-gray-700 backdrop-blur-sm bg-white/80 dark:bg-gray-900/80">
            ...
            {error && (
              <p className="mt-3 text-red-500 dark:text-red-400 text-sm font-medium">
                {error}
              </p>
            )}
          </Card>
